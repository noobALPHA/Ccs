...
━━━━━━━━━━━━━━━━━ 
ꑭ < 𝒃𝒊𝒏 ⌯ {cc[:6]} | {bin_json['data']['countryInfo']['emoji']}
ꑭ < 𝐶𝑎𝑟𝑑 ⌯ `{cc}|{mes}|{ano}|{cvv}`↯ 
🥀« 𝐼𝑛𝑓𝑜 ⌯  {bin_json['data']['type']} ↯ 
🥀« 𝑇𝑦𝑝𝑒 ⌯ {bin_json['data']['level']}↯ 
🥀« 𝐵𝑎𝑛𝑘 ⌯ {bin_json['data']['bank']} ↯ 
🥀« 𝑪𝒐𝒖𝒏𝒕𝒓𝒚 ⌯ {bin_json['data']['countryInfo']['name']} | {bin_json['data']['countryInfo']['emoji']} ↯ 
🥀 « 𝐸𝑥𝑡𝑟𝑎 ⌯
